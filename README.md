...
| :-------------------------------------------------------------------------------- | :----- | :----- | :----- | :----------------------- |
| [diffutils](https://ftpmirror.gnu.org/diffutils/)                                 | 3.10   | 3.12   | 3.11   |                          |
...
| [libcurl](https://curl.se/download.html)                                          | 8.10.1 | 8.14.1 | 8.13.0 |                          |
...
| [libxml2](https://gitlab.gnome.org/GNOME/libxml2)                                 | 2.13.4 | 2.14.4 | 2.14.1 |                          |
| [libyaml](https://pyyaml.org/wiki/LibYAML)                                        | 0.2.5  | 0.2.5  | 0.2.5  |                          |
| [LMDB](https://github.com/LMDB/lmdb/)                                             | 0.9.33 | 0.9.33 | 0.9.33 |                          |
| [OpenLDAP](https://www.openldap.org/software/download/OpenLDAP/openldap-release/) | 2.6.8  | 2.6.10 | 2.6.9  | Enterprise agent only    |
...
| [APR](https://apr.apache.org/)                      | 1.7.5  | 1.7.6  | 1.7.5  |
| [apr-util](https://apr.apache.org/)                 | 1.6.3  | 1.6.3  | 1.6.3  |
| [Git](https://www.kernel.org/pub/software/scm/git/) | 2.47.0 | 2.50.0 | 2.49.0 |
| [libexpat](https://libexpat.github.io/)             | -      | 2.7.1  | 2.7.1  |
| [PHP](https://php.net/)                             | 8.3.13 | 8.3.22 | 8.4.5  |
| [PostgreSQL](https://www.postgresql.org/)           | 15.8   | 16.9   | 17.4   |
